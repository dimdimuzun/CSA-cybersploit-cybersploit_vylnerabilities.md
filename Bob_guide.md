...
![main_page](image-3.png)


Передивимось **robots.txt**:
![robots.txt](image-4.png)
...
![dev_shell_reverse](image-7.png)

Та отримуємо наступний результат:
![reverse_shell](image-8.png)
...
``` 
Отримуємо результат:
![.old_passwordfile.html](image-11.png)
...
Маємо цікавий файл.
![theadminisdumb.txt](image-13.png)

Визначаємо зміст:
![theadminisdumb](image-14.png)
...
![cat staff.txt](image-16.png)
**cat staff.txt** - це скоріше про інтригі в команді
![cat login.txt.gpg](image-17.png) 
