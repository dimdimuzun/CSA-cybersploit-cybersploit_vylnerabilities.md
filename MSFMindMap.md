Нижче — готові **Mermaid-діаграми**, які можна вставляти у Markdown (GitHub, GitLab, Obsidian, MkDocs, де підтримується Mermaid).
...
1. Спочатку показати Mindmap
2. Потім Reverse TCP sequence
3. Далі Lifecycle
4. Після практики  — повернутись та передивитсь діаграми
